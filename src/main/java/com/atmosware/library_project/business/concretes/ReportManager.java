...
public class ReportManager implements ReportService {
    ...
    public Map<String, Long> getStockInfo() {
        ...
        long borrowedCount = this.bookRepository.countByStatus(Status.BORROWED);
        long returnedCount = this.bookRepository.countByStatus(Status.RETURNED);
        long newCount = this.bookRepository.countByStatus(Status.NEW);
